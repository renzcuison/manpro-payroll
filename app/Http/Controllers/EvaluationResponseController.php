...
class EvaluationResponseController extends Controller
{
    ...
    //     try {
    //         $evaluationResponse = EvaluationResponse::where('id', $request->id)->first();
    ...
    //         // Fetch related users
    //         $evaluatee = \App\Models\UsersModel::find($evaluationResponse->evaluatee_id);
    //         $evaluator = \App\Models\UsersModel::find($evaluationResponse->evaluator_id);
    //         $primary = \App\Models\UsersModel::find($evaluationResponse->primary_commentor_id);
    //         $secondary = \App\Models\UsersModel::find($evaluationResponse->secondary_commentor_id);
    ...
    //         // Fetch the evaluation form with creator, sections, subcategories, and options
    ...
    //                     }]);
    //             }
    //         ])->where('id', $evaluationResponse->form_id)->first();

    //         $creator_user_name = $form && $form->creator ? $form->creator->user_name : null;

    //         // Build the form object for response
    //         $evaluationForm = null;
    //         if ($form) {
    //             $evaluationForm = [
    //                 'id' => $form->id,
    ...
    //                     // Get answers for this response/subcategory
    //                     $percentage_answer = \App\Models\EvaluationPercentageAnswer::where([
    //                         ['response_id', $evaluationResponse->id],
    //                         ['subcategory_id', $subcat->id]
    //                     ])->first();
    //                     $text_answer = \App\Models\EvaluationTextAnswer::where([
    //                         ['response_id', $evaluationResponse->id],
    //                         ['subcategory_id', $subcat->id]
    //                     ])->first();

    //                     // Get options + option answers for this response/subcategory
    //                     $options = [];
    //                     foreach ($subcat->options as $option) {
    //                         $option_answer = \App\Models\EvaluationOptionAnswer::where([
    //                             ['response_id', $evaluationResponse->id],
    //                             ['option_id', $option->id]
    //                         ])->first();
    //                         $options[] = [
    ...
    //         // Use the new UsersModel for all user lookups
