            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="20" style=" color: #5a5f61; font-family:verdana;">
                <tr>
                    <td>
                        ...
                        <div><br></div>
                        <div>We received a login request for your account. To verify your identity, please use the following OTP verification code below.
                            <div><br></div>
                            OTP Code:&nbsp;{{ $details['verifyCode']}}
                            <br><br>
                            This OTP is valid for a limited time period and should not be shared with anyone. If you did not request this verification, please ignore this email.
                            &nbsp;
                        </div>
                    </td>
                </tr>
