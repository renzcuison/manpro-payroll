...
import { Box, Typography, Grid, Paper, Avatar, Button, Menu, MenuItem, useMediaQuery, 
useTheme, IconButton, Stack, Divider, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, } from "@mui/material";
    ...
    return (
        <Layout title={"ProfileView"}>
                ...
                <Box>
                    <Box sx={{ mt: 5, display: "flex", justifyContent: "space-between", px: 1, alignItems: "center", }} >
                        <Typography variant="h4" sx={{ fontWeight: "bold", display: "flex", alignItems: "center", }} >
                            <Link to="/dashboard" style={{ textDecoration: "none", color: "inherit", }} >
                                <i className="fa fa-chevron-left" aria-hidden="true" style={{ fontSize: "80%", cursor: "pointer", }}/>
                            </Link>
                            &nbsp; User Profile
                        </Typography>
                    ...
                    <Grid container spacing={4} sx={{ mt: 2 }}>
                        ...
                        <Grid size={{ xs: 8, sm: 8, md: 8, lg: 8 }}>
                            ...
                            <EducationalBackground education={education}/>
                            <UserEmploymentDetails user={user}/>
                        </Grid>
                    </Grid>
                </Box>
            </Box>
            ...
            {openProfileEditModal && (
                <ProfileEdit open={openProfileEditModal} close={handleCloseProfileEditModal}
                employee={user} avatar={user?.media[0]?.original_url} medScreen={medScreen} />
            )}
        </Layout>
    );
};
