...
import PerformanceEvaluationCreatorSign from './PerformanceEvaluationCreatorSign';

const PerformanceEvaluationCreatorAcknowledge = ({ open, onClose, onProceed }) => {
    ...
    return (
        <>
                ...
                <DialogContent>
                    <Box sx={{ mt: 2 }}>
                        <Typography sx={{ fontSize: 16, color: '#4A4A4A', mb: 7 }}>
                            I acknowledge that I have created and reviewed this performance evaluation.
                        </Typography>
            ...
            {/* Signature Modal */}
            <PerformanceEvaluationCreatorSign
                open={signModalOpen}
...
export default PerformanceEvaluationCreatorAcknowledge;