...
const AddOvertimeType = ({ open, close }) => {
    ...
    const checkInput = (event) => {
        ...
        if (!name || !percentage) {
            ...
            Swal.fire({
                customClass: { container: "my-swal" },
                title: "Are you sure?",
                text: "This overtime type will be added",
                icon: "warning",
                showConfirmButton: true,
            ...
            <Dialog
                ...
                <DialogTitle sx={{ padding: 4, paddingBottom: 1 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Typography variant="h4" sx={{ marginLeft: 1, fontWeight: 'bold' }}> Add Overtime Type </Typography>
