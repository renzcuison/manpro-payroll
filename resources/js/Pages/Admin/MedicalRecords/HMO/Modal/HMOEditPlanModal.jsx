...
const HMOEditHMOPlanModal = ({ open, onClose, plan, user, onSave }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await axiosInstance.post(`/medicalRecords/editHMOPlan/${plan.id}`, payload, {
        ...
        <Dialog open={open} fullWidth maxWidth="md"PaperProps={{ style: { padding: '16px', backgroundColor: '#f8f9fa', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px', borderRadius: '20px', minWidth: '500px', marginBottom: '5%' }}}>
                    <DialogTitle sx={{ padding: 4, paddingBottom: 1 }}>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Typography variant="h4" sx={{ marginLeft: 1 ,fontWeight: 'bold' }}> Edit HMO Plan</Typography>
...
export default HMOEditHMOPlanModal;
