...
const HMOAssignEmployee = ({ open, close, planId, refreshEmployees }) => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            const res = await axiosInstance.post('/medicalRecords/saveHMOEmployees', payload, {
            ...
            Swal.fire({
                icon: 'success',
                title: "Success",
                text: 'HMO Employee added successfully.',
                timer: 2000,
                showConfirmButton: false
            });
            close();
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: "Error adding HMO Employee."
            });
        }
    };
                            ...
                            {showDependents && (
                                <><Box sx={{ height: 24 }} />
                                    ...
                                    <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 2, mb: 2, }}>
                                        ...
                                        <Grid item spacing={2} >
                                            <FormControl sx={{
                                                justifyContent: 'space-between', marginBottom: 3, width: '45%', '& label.Mui-focused': { color: '#97a5ba' },
                                                '& .MuiOutlinedInput-root': { '&.Mui-focused fieldset': { borderColor: '#97a5ba' } },
                                            }}>
                                    ...
                                    {dependents.slice(1).map((dep, index) => (
                                        <Box key={index + 1} sx={{ border: '1px solid #ccc', borderRadius: 1, p: 1, mb: 1 }}>
                                            ...
                                            <Grid container spacing={2}>
                                                <FormControl sx={{
                                                    marginLeft: 1, marginBottom: 3, width: '44%', '& label.Mui-focused': { color: '#97a5ba' },
                                                    '& .MuiOutlinedInput-root': { '&.Mui-focused fieldset': { borderColor: '#97a5ba' } },
                                                }}>
                                                ...
                                                <FormControl sx={{
                                                    marginBottom: 3, width: '44%', '& label.Mui-focused': { color: '#97a5ba' },
                                                    '& .MuiOutlinedInput-root': { '&.Mui-focused fieldset': { borderColor: '#97a5ba' } },
                                                }}>
                                                    <Grid item xs={12} sm={5}>
...
export default HMOAssignEmployee;