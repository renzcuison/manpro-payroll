...
import { Box, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, Grid, TextField, FormControl, InputLabel, Select, MenuItem, Menu } from '@mui/material';
                ...
                <Box sx={{ overflowX: 'auto', width: '100%', whiteSpace: 'nowrap' }}>
                    <Box sx={{ mx: 'auto', width: { xs: '100%', md: '1400px' } }}>
                        ...
                        >
                            ...
                            <div>
                                <Button variant="contained" onClick={handleMenuClick} endIcon={<ArrowDropDownIcon />} sx={{ backgroundColor: '#177604', color: 'white', '&:hover': { backgroundColor: '#126703' } }} >
                                    Edit
                                </Button>
                                <Menu
                                    anchorEl={anchorEl}
