...
import { Grid, Table, TableBody, TableCell, TableContainer, TablePagination, TableRow, Box, Typography, CircularProgress } from '@mui/material';
...
const MemberForEvaluation = () => {
    ...
    useEffect(() => {
        axiosInstance.get(`/getEmployeeEvaluations`, {headers})
            .then((response) => {
            ...
            <Box sx={{ mx: 12 }}>
                <Grid item sx={{ marginTop: 6, marginBottom: 4 }}>
                    <Box display="flex" justifyContent="space-between" alignItems="center" p={0} >
                        <Typography variant="h5" component="h5" > MY PERFORMANCE EVALUATION </Typography>
                    </Box>
                </Grid>
