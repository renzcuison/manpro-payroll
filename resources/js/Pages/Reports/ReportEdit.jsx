...
const ReportEdit = () => {
            ...
            axiosInstance
                ...
                .then((response) => {
                    ...
                    const assignedEmployees =
                        response.data.selectedEmployees.map(
                            (emp) => emp.user_id
                        );
    ...
    const checkInput = (event) => {
        ...
        const selectedEmployee = selectedEmployees
            .map((name) => {
                const employee = employees.find(
                    (emp) => `${emp.fname} ${emp.lname}` === name
                );
    ...
    const saveEdit = (event) => {
        ...
        axiosInstance
            .post("/editReport", formData, { headers })
            .then((response) => {
    ...
    return (
        <Layout title={"ReportCreateForm"}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Select
                                            ...
                                            input={
                                                <OutlinedInput label="Assigned Employee" />
                                            }
            ...
            <ReportsAddTypeModal
                ...
                close={closeAddReportTypeModal}
                onReportTypeAdded={addReportType}
            />
        </Layout>
    );
};
