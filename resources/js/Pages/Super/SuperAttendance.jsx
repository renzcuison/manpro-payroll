...
import SuperApplicationsChooseModal from '../../components/Modals/SuperApplicationsChooseModal';
...
const SuperAttendance = () => {
    ...
    const handleViewAttendance = (id) => {
        navigate(`/hr/attendance?month=${moment().format('MM')}&year=${moment().year()}&employeeID=` + id)
    }

    return (<Layout title={"Employees"}>
        <div className="content-heading d-flex justify-content-between p-0">
            <h5 className='pt-3'>Attendance</h5>
        </div>
        <div className='block'>
                                            ...
                                            <TableCell>
                                                <Stack direction='row' alignItems='center' justifyContent='flex-end'>
                                                    <Button
                                                        ...
                                                        onClick={() => handleViewAttendance(emp.user_id)}
                                                    >
        ...
        <SuperApplicationsChooseModal open={openChoose} close={handleCloseChoose} teamID={userID} />
    </Layout >
    )
}
