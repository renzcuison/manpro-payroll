...
const HrEvaluationCreateForm = () => {
    ...
    const handleEvaluationForm = (formID) => {
        ...
        axiosInstance
            .get(`/getEvaluation`, { params: data, headers })
            .then((response) => {
        ...
        axiosInstance
            .get(`/getCategories`, { params: data, headers })
            .then((response) => {
        ...
        axiosInstance
            .get(`/getRatings`, { params: data, headers })
            .then((response) => {
    ...
    const handleEmployee = (empID) => {
        const selectedEmployee = employees.find(
            (employee) => employee.user_id === empID
        );
    ...
    const saveInput = (event) => {
        ...
        axiosInstance
            .post("/saveEvaluationForm", data, { headers })
            .then((response) => {
                if (response.data.status === 200) {
                    Swal.fire({
                        customClass: { container: "my-swal" },
                        ...
                        navigate(
                            `/hr/performance-evaluation-review/${response.data.formId}`
                        );
                    });
                }
            })
                        ...
                        >
                            ...
                            >
                                <TextField
                                    ...
                                    onChange={(event) =>
                                        handleEmployee(event.target.value)
                                    }
                                >
                        ...
                        >
                            ...
                            >
                                <TextField
                                    ...
                                    onChange={(event) =>
                                        handleEvaluator(event.target.value)
                                    }
                                >
                                    {employees.map((employee) => (
                                        <MenuItem
                        ...
                        >
                            ...
                            >
                                <TextField
                                    ...
                                    value={evaluationID}
                                    onChange={(event) =>
                                        handleEvaluationForm(event.target.value)
                                    }
                                >
