                    ...
                    employees.map((response) => (
                      ...
                      >
                        <TableCell align="center">
                          {highlightMatch(response.company_name ?? "Unknown", search)}
                        </TableCell>
                        <TableCell align="center">
                        ...
                        <TableCell align="center">
                          {highlightMatch(response.branch ?? "", search)}
                        </TableCell>
                        <TableCell align="center">
                          {highlightMatch(response.department ?? "", search)}
                        </TableCell>
                        <TableCell align="center">
                          {highlightMatch(response.role ?? "", search)}
                        </TableCell>
                      </TableRow>
                    ))
                    )}
