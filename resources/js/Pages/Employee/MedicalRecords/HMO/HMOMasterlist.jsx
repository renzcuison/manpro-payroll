...
import HMOPlanEdit from "./Modal/HMOPlanEdit";
import { useNavigate } from "react-router-dom";
import axiosInstance, { getJWTHeader } from '../../../../utils/axiosConfig';
// import useEmployeeHMOPlans from '../../../../hooks/useEmployeeHMOPlans';
...
const HMOMasterlist = () => {
  ...
  useEffect(() => {
    axiosInstance
      ...
      .then((res) => {
        console.log("HMO Plan Data:", res.data);
      ...
      <Box sx={{ overflowX: "auto", width: "100%", whiteSpace: "nowrap" }}>
        <Box sx={{ mx: "auto", width: { xs: "100%", md: "1100px" } }}>
          <Box sx={{ mt: 5, display: 'flex', justifyContent: 'space-between', px: 1, alignItems: 'center' }}>
            <Typography variant="h4" sx={{ fontWeight: "bold" }}>My HMO Plans</Typography>
          </Box>
          <Box>
