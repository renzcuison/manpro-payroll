...
const PreviewProposal = ({
  ...
  const calculateAmortizationSchedule = () => {
    ...
    for (let month = 1; month <= n; month++) {
      ...
      schedule.push({
        ...
        status: 'Unpaid', // Add default status as "Unpaid"
      });
    }
    return schedule;
  };
  ...
  const handleCreateProposal = () => {
    ...
    Swal.fire({
      ...
      text: 'Are you sure you want to send this proposal to the employee?',
      icon: 'question',
            ...
            <Table stickyHeader>
              <TableHead>
                <TableRow>
                  ...
                  {proposal.status === 'Approved' && <TableCell>Status</TableCell>}
                </TableRow>
              </TableHead>
              <TableBody>
                {amortizationSchedule.map((row) => (
                  <TableRow key={row.month}>
                    ...
                    {proposal.status === 'Approved' && <TableCell>{row.status}</TableCell>}
                  </TableRow>
                ))}
              </TableBody>
            </Table>
