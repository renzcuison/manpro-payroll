...
const ReportsAddTypeModal = ({ open, close, onReportTypeAdded }) => {
    ...
    const checkInput = (event) => {
        ...
        if ( !typeName ){
            Swal.fire({
                ...
                text: "Document Type Name is Required!",
                icon: "error",
                timer: 3000,
            ...
            new Swal({
                customClass: { container: "my-swal" },
                title: "Are you sure?",
                text: "You want to add this document type?",
                icon: "warning",
                showConfirmButton: true,
    ...
    const saveInput = (event) => {
        ...
        axiosInstance.post('/saveReportType', data, { headers })
            .then(response => {
                if (response.data.status === 200) {
                    ...
                    onReportTypeAdded({ id: response.data.reportTypeID, type_name: typeName });
                    ...
                    Swal.fire({
                        customClass: { container: 'my-swal' },
                        text: "Document Type already exist!",
                        icon: "warning",
                        showConfirmButton: true,
                        confirmButtonText: 'Proceed',
                        confirmButtonColor: '#177604',
            ...
            <Dialog open={open} fullWidth maxWidth="md" PaperProps={{ style: { backgroundColor: '#f8f9fa' } }}>
                ...
                <div className='px-4 block-content bg-light' style={{ boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px', borderRadius: '20px', minWidth: '800px', maxWidth: '1000px' }}>
                    <Box component="form" sx={{ mx: 6, mt: 3, mb: 6 }} onSubmit={checkInput} noValidate autoComplete="off" encType="multipart/form-data" >
                        ...
                        <Typography variant="h4" sx={{ mt: 3, mb: 6, fontWeight: 'bold' }} > Add Document Type </Typography>
...
export default ReportsAddTypeModal;
