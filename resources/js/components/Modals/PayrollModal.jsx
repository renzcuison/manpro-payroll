...
const PayrollModal = ({ open, close, data, cutoff, type, processtype }) => {
    ...
    return (
        <Dialog open={open} fullWidth maxWidth="lg">
            ...
            <DialogContent>
                <div className=" payroll_details pt-10 px-2" ref={contentToPrint} style={{ '@media print': {'@page': { size: '12in 11in', margin: '1in' }} }}>
                    <div>
                        <img className="d-flex justify-content-center" src={HomeLogo} style={{height: 70, width: 200, margin: '0 auto', display: 'block'}} />
