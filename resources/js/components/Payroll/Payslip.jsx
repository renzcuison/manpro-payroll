        ...
        <>
            <Box component="form" sx={{ mt: 3, py: 6, bgcolor: '#ffffff' }} noValidate autoComplete="off" encType="multipart/form-data">
                <Box display="flex" flexDirection="column" alignItems="center" sx={{ mt: 1 }}>
                    ...
                    <Typography sx={{ marginTop: '5px' }}> Online Payslip {payroll.total_earnings} </Typography>
                    <Typography sx={{ marginTop: '5px' }}> Pay Period: {formatDate(payroll.period_start)} - {formatDate(payroll.period_end)}</Typography>
                </Box>
