...
const AdditionalBenefitsTable = () => {
    ...
    useEffect(() => {
        ...
        axiosInstance.get(`/additional_benefits/${1}/${empID}`, { headers }).then((response) => {
    ...
    return (
        <>
            ...
            <HrEmployeeAdditionalBenefitModal open={openModal} close={handleCloseModal} type={1} benefitData={null} />
        </>
    )
}
