				...
				<div className="content-header-section">
					<div className="btn-group" role="group">
						...
						>
							...
							<span className="d-none d-sm-inline-block text-dark" style={{ textTransform: 'none' }}>{user.fname} {user.lname}</span>
						...
						>
							<MenuItem
								className="dropdown-item dropdown-menu-right min-width-200"
